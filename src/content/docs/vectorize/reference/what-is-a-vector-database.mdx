...
2. The output embeddings are inserted into a Vectorized database index.
...
4. Vectorized database is queried with this embedding, and returns a set of the most similar vector embeddings to the provided query.
